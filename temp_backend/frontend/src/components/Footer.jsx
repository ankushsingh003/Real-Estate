        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-4">
              <a href="https://google.com" target="_blank" rel="noopener noreferrer" className="w-11 h-11 rounded-xl bg-white/40 border border-slate-200 flex-center hover:bg-primary hover:border-primary hover:scale-110 transition-all text-slate-500 hover:text-white shadow-sm group">
                <Globe size={20} />
              </a>
              <a href="mailto:hello@luxeestate.com" className="w-11 h-11 rounded-xl bg-white/40 border border-slate-200 flex-center hover:bg-primary hover:border-primary hover:scale-110 transition-all text-slate-500 hover:text-white shadow-sm group">
                <Send size={20} />
              </a>
              <Link to="/concierge" className="w-11 h-11 rounded-xl bg-white/40 border border-slate-200 flex-center hover:bg-primary hover:border-primary hover:scale-110 transition-all text-slate-500 hover:text-white shadow-sm group">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-600">
              {[
                ...
                { name: 'VIP Concierge', path: '/concierge' },
                { name: 'List Property', path: '/add-property' }
              ].map((item) => (
                <li key={item.name}>
                  <Link to={item.path} className="hover:text-primary hover:translate-x-2 transition-all flex items-center gap-2 group font-bold text-sm uppercase tracking-widest">
          ...
          <div>
            ...
            <ul className="space-y-4 text-slate-600">
              {[
                ...
                { name: 'Sell Your Home', path: '/add-property' },
                { name: 'Market Analysis', path: '/properties' },
                { name: 'VIP Chat', path: '/concierge' }
              ].map((item) => (
                <li key={item.name}>
                  <Link to={item.path} className="hover:text-primary hover:translate-x-2 transition-all flex items-center gap-2 group font-bold text-sm uppercase tracking-widest">
                    <div className="w-1 h-1 bg-slate-300 rounded-full group-hover:bg-primary group-hover:w-3 transition-all"></div>
